...
public class DemostracionOperadores {
	...
	public static void main(String[] args) {
        ...
        // -------------------------------------------------------------
        System.out.println("--- 3. OPERADORES DE RELACIONALES ---");
        ...
        boolean menor = (c < 5);      // Menor que
        boolean mayorIgual = (a >= 10); // Mayor o igual que
        ...
        System.out.println("c es menor que 5 (c < 5): " + menor);
        System.out.println("a es mayor o igual a 10 (a >= 10): " + mayorIgual);
        ...
        System.out.println("NOT (!x): " + resultadoNOT);
        ...
        System.out.println("Asignación simple (d = 20): " + d);
        d += 5;         // Asignación de suma (d = d + 5)
        System.out.println("Asignación de suma (d += 5, ahora d vale): " + d);
        d -= 2;         // Asignación de resta (d = d - 2)
        System.out.println("Asignación de resta (d -= 2, ahora d vale): " + d);
        d *= 2;         // Asignación de multiplicación (d = d * 2)
        System.out.println("Asignación de multiplicación (d *= 2, ahora d vale): " + d);
        d /= 5;         // Asignación de división (d = d / 5)
        System.out.println("Asignación de división (d /= 5, ahora d vale): " + d);
        d %= 2;         // Asignación de módulo (d = d % 2)     
        System.out.println("Asignación de módulo (d %= 2, ahora d vale): " + d);
