...
public class DetalleDeFactura {
	...
	public static void main(String[] args) {
		...
		String nombre_factura = sc.nextLine();
		System.out.println("Introduzca precio de producto 1: ");
		double precio1 = sc.nextDouble();
		System.out.println("Introduzca precio de producto 2: ");
		double precio2 = sc.nextDouble();
		double totalBruto = precio1 + precio2;
		double impuesto = totalBruto * 0.19;
		double monto = totalBruto + impuesto;

		System.out.printf("La factura %s tiene un total bruto de %.2f, con un impuesto de %.2f y el monto después de impuesto es de %.2f%n", nombre_factura, totalBruto, impuesto, monto);
