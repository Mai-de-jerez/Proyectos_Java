...
<head>
    ...
    <title>Lista de Vehículos - Sistema de Gestión</title>
            ...
            <table id="tablaVehiculos">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="DetalleCocheServlet?id=<%= v.getId() %>" class="row-btn btn-success btn-small">Ver más</a>
                            <a href="EditarVehiculo?id=<%= v.getId() %>" class="row-btn btn-primary btn-small">Editar</a>
                            <a href="EliminarVehiculo?id=<%= v.getId() %>" class="row-btn btn-secondary btn-small" onclick="return confirm('...')">Eliminar</a>
                        </td>
